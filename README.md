...
7. Wait For Operationn End (Boolean) **Optional** - Whether to wait until the API finished creating the subnetwork or not. Default value is false.
...
### Parameters
1. Credentials (Vault) **Optional** - Credentials for authenticating to the google cloud API. 
2. Subnet Name (String) **Required** - The name of the sunetwork to reserve this IP address from.
